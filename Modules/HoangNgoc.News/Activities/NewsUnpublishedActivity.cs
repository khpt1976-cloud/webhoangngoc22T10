...
{
    public class NewsUnpublishedActivity : EventActivity
    {
        public static string EventName => nameof(NewsUnpublishedActivity);
        
        private readonly IStringLocalizer S;

        public NewsUnpublishedActivity(IStringLocalizer<NewsUnpublishedActivity> localizer)
        {
            S = localizer;
        }

        public override string Name => EventName;
        public override LocalizedString DisplayText => S["News Unpublished"];
        ...
        public override ActivityExecutionResult Execute(WorkflowExecutionContext workflowContext, ActivityContext activityContext)
        {
            ...
            if (newsArticlePart != null)
            {
                ...
                workflowContext.Properties["NewsUnpublishedDate"] = DateTime.UtcNow;
            }
